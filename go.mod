...
require (
	...
	go.opentelemetry.io/otel/sdk v1.35.0 // indirect; needed by go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.46.0
	golang.org/x/crypto v0.38.0 // indirect; to address CVE-2024-45337
	golang.org/x/net v0.40.0 // indirect; to address GO-2024-3333
	k8s.io/api v0.31.1
