...
$ mkdir -p v4.19/catalog/openshift-secondary-scheduler-operator
$ opm alpha convert-template basic -o yaml ./catalog-migrate/openshift-secondary-scheduler-operator/catalog.json > v4.19/catalog-template.yaml
```
...
$ opm alpha render-template basic v4.19/catalog-template.yaml --migrate-level bundle-object-to-csv-metadata > v4.19/catalog/openshift-secondary-scheduler-operator/catalog.json
```
