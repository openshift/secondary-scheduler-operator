...
$ opm alpha render-template basic v4.20/catalog-template.yaml --migrate-level bundle-object-to-csv-metadata > v4.20/catalog/openshift-secondary-scheduler-operator/catalog.json
