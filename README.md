...
$ opm alpha convert-template basic -o yaml ./catalog-migrate/openshift-secondary-scheduler-operator/catalog.json > v4.12/catalog-template.yaml
```
...
$ opm alpha render-template basic v4.12/catalog-template.yaml > v4.12/catalog/openshift-secondary-scheduler-operator/catalog.json
```
