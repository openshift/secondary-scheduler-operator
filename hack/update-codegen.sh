...
# 1. copy paste pkg/apis/descheduler/v1/types_secondaryscheduler.go under github.com/openshift/api/ under operator/v1 directory (and update the file to remove the cyclic dependency)
