...
import (
	...
	_ "github.com/openshift/secondary-scheduler-operator/test/extended"
)

func main() {
	registry := e.NewRegistry()
	ext := e.NewExtension("openshift", "payload", "secondary-scheduler-operator")

	// Suite: conformance/parallel (fast, parallel-safe)
	ext.AddSuite(e.Suite{
		Name:    "openshift/secondary-scheduler-operator/conformance/parallel",
	...
	ext.AddSuite(e.Suite{
		Name:    "openshift/secondary-scheduler-operator/conformance/serial",
	...
	ext.AddSuite(e.Suite{
		Name:    "openshift/secondary-scheduler-operator/optional/slow",
	...
	ext.AddSuite(e.Suite{
		Name: "openshift/secondary-scheduler-operator/all",
	})
	...
	root := &cobra.Command{
		Long: "Secondary Scheduler Operator Tests Extension",
	}
