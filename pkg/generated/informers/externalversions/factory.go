...
type SharedInformerFactory interface {
	...
	Secondaryschedulers() secondaryscheduler.Interface
}

func (f *sharedInformerFactory) Secondaryschedulers() secondaryscheduler.Interface {
	return secondaryscheduler.New(f, f.namespace, f.tweakListOptions)
}
